                        ...
                        <div class="-mx-px border-l border-gray-200 grid grid-cols-2 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                <div
                                    ...
                                    <img class="w-full h-full object-cover object-center"
                                        src="https://dashboard-api.flyfood.vn/system/product_images/3822/image.jpg">

                                </div>
                                <div class="pt-10 pb-4 text-center">
                                    <h3 class="text-sm font-medium text-gray-900">
                                        <a href="/food/com-ga-la-sen">
                            ...
                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                <div
                                    class="rounded-lg overflow-hidden bg-gray-200 aspect-w-8 aspect-h-9 group-hover:opacity-75">
                                    <img class="w-full h-full object-cover object-center"
                                        src="https://dashboard-api.flyfood.vn/system/product_images/4012/image.jpg">
                                </div>
                                <div class="pt-10 pb-4 text-center">
                                    <h3 class="text-sm font-medium text-gray-900">
                                        <a href="/food/com-ga-la-sen">
                            ...
                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                <div
                                    class="rounded-lg overflow-hidden bg-gray-200 aspect-w-8 aspect-h-9 group-hover:opacity-75">
                                    <img class="w-full h-full object-cover object-center"
                                        src="https://dashboard-api.flyfood.vn/system/product_images/3814/image.jpg">
                                </div>
                                <div class="pt-10 pb-4 text-center">
                                    <h3 class="text-sm font-medium text-gray-900">
                                        <a href="/food/com-ga-la-sen">
                            ...
                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                <div
                                    class="rounded-lg overflow-hidden bg-gray-200 aspect-w-8 aspect-h-9 group-hover:opacity-75">
                                    <img class="w-full h-full object-cover object-center"
                                        src="https://dashboard-api.flyfood.vn/system/product_images/3906/image.png">
                            ...
                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                <div
                                    class="rounded-lg overflow-hidden bg-gray-200 aspect-w-8 aspect-h-9 group-hover:opacity-75">
                                    <img class="w-full h-full object-cover object-center"
                                        src="https://dashboard-api.flyfood.vn/system/product_images/3818/image.jpg">
                                ...
                                <div class="pt-10 pb-4 text-center">
                                    ...
                                    <div class="mt-3 flex-1 flex flex-col items-center">
                                        <p class="sr-only">5.0000 out of 5 stars</p>
                                        <div class="flex items-center">
                                            <svg class="h-5 w-5 flex-shrink-0 text-yellow-400"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor" aria-hidden="true">
